...
CREATE VIEW "public"."vw_wallet_transfer_groups" AS (select "wallets"."id", DATE("wallet_transactions"."recordedAt") as "burst", 
       ...
       as "funding_to_reward_ratio" from "wallets" left join "wallet_transactions" on ("wallet_transactions"."from" = "wallets"."id" or "wallet_transactions"."to" = "wallets"."id") group by "burst", "wallets"."id");